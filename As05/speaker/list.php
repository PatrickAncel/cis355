...
<?php
    ...
    echoHTMLHead("As05 - List of Speakers", "../");
?>

<body>
    <div class="container mt-2">
        <h1>As05 - List of Speakers</h1>
            ...
            <tbody>
                <?php
                    ...
                    while ($speaker = $preparedQuery->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        if (strlen($speaker['Photo']) == 0) {
                            echo "<td></td>";
                        } else {
                            echo "<td><img style='max-height:30vh' src='data:" . $speaker['ImageType'] . ";base64,"
                            . base64_encode($speaker['Photo']) . "'></td>";
                        }
                        echo "<td>";
                        echo "<a href='read.php?id=" . $speaker['ID'] . "' ><button class='btn btn-primary'>Read</button></a>";
                        echo "<a href='update.php?id=" . $speaker['ID'] . "' ><button class='btn btn-dark'>Update</button></a>";
                        echo "<a href='delete.php?id=" . $speaker['ID'] . "' ><button class='btn btn-danger'>Delete</button></a>";
